...
const values = [
  {
    ...
    badgeClassName: 'bg-[#d7f0d1] text-[#1c8f53]',
  },
  {
    icon: EyeOff,
  ...
  return (
    <div>
      <section className="mx-auto max-w-[1280px] px-4 pb-4 pt-10 sm:px-6 lg:pt-14">
        <p className="text-sm font-semibold uppercase tracking-wide text-[#1a8f57]">About Campus Coin</p>
      ...
      <section className="mx-auto max-w-[1280px] px-4 py-10 sm:px-6">
        <div className="grid gap-10 rounded-[28px] bg-white p-8 shadow-sm sm:p-10 lg:grid-cols-2 lg:gap-16">
          <div>
            <h2 className="text-2xl font-bold text-[#1d3d2d]">Why we built this</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#1d3d2d]">What Campus Coin does instead</h2>
            <p className="mt-4 text-sm leading-relaxed text-gray-600">
      ...
      <section className="mx-auto max-w-[1280px] px-4 py-10 sm:px-6">
        <h2 className="text-2xl font-bold text-[#1d3d2d]">What you get</h2>
        <div className="mt-6 grid gap-6 sm:grid-cols-2">
          {values.map(({ icon: Icon, title, description, badgeClassName }) => (
            <div
              key={title}
              className="group rounded-[26px] bg-[#f6f4ee] p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:bg-[#f2efe9] hover:shadow-md"
            >
              <span
              ...
              <h3 className="font-semibold text-[#1d3d2d]">{title}</h3>
      ...
      <section className="mx-auto max-w-[1280px] px-4 py-10 sm:px-6">
        <div className="rounded-[28px] bg-[#122a1f] px-6 py-12 text-white sm:px-12">
